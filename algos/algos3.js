...
//     let shifts = amnt % str.length 
//     let returnStr = str.slice(-shifts) + str.slice(0,-shifts)
//     return returnStr
...
function isRotation(s1, s2) {
    ...
    let sInd = s2.indexOf(s1[0])
    // console.log(sInd)
    let sStr = s2.slice(sInd) + s2.slice(0,sInd)
    console.log("s1:", s1," -- sStr:", sStr)
    
    return (s1 === sStr ? true:false)
}
